...
class ElementsControllerTest < ActionController::TestCase
  ...
  test "should create element" do
    assert_difference('Element.count') do
      post :create, element: { description: @element.description, name: @element.name }
    end
  ...
  test "should update element" do
    patch :update, id: @element, element: { description: @element.description, name: @element.name }
    assert_redirected_to element_path(assigns(:element))
  end
